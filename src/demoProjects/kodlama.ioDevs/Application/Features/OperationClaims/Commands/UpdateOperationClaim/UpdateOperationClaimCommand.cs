    ...
    public class UpdateOperationClaimCommand : IRequest<UpdatedOperationClaimDto>
    {
        ...
        public class UpdateOperationClaimCommandHandler : IRequestHandler<UpdateOperationClaimCommand, UpdatedOperationClaimDto>
        {
            ...
            public async Task<UpdatedOperationClaimDto> Handle(UpdateOperationClaimCommand request, CancellationToken cancellationToken)
            {
                ...
                await _operationClaimBusinessRules.OperationClaimMustExistWhenRequested(operationClaim.Id);
                await _operationClaimBusinessRules
                    .OperationClaimNameCanNotBeDublicatedWhenInserted(operationClaim.Name);
